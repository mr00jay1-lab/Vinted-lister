...
| 52 | **Bug:** iOS OOM crash when adding 7+ photos from library — `model.detect` was receiving the full-resolution image element (up to ~147 MB tensor per call); mediums were also held in JS heap simultaneously | In dev |
